<?php
	...
	*/
	...
	$sql = "INSERT INTO User(name,last_name,email,age,ocupation,school,work,link_face_profile,interest_home,state,especific_topic) 
	VALUES('$name','$last_name','$email','$age','$ocupation','$state','$school','$work','$link_face_profile','$interest_home','$especific_topic')";
	...
	if ($conn->query($sql) === TRUE) {
		try {
			...
			imagettftext($im, 80, 0, $center, 1275, $color, $fuente, $cadena);
			imagepng($im);
		} catch (Exception $e) {
			//throw $th;
			die($e);
