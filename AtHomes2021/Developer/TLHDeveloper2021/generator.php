<?php
	...
	$sql = "INSERT IGNORE INTO $Table (name,last_name,email,age,ocupation,school,work,link_face_profile,interest,state,first_day_conf,sec_day_conf,gender,device,hobbie,topic_interest,social_media,profesional,studies) 
	VALUES('$name','$last_name','$email','$age','$ocupation','$school','$work','$link_face_profile','$interest','$state','$FirstDayConf','$SecDayConf','$genero','$device','$hobbie','$topic_interest','$social_media','$profesional','$studies')";
